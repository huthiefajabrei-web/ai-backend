...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#040508] text-slate-50 p-6 relative overflow-hidden selection:bg-amber-500/30">
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute -top-[15%] -left-[10%] w-[45vw] h-[45vw] rounded-full bg-amber-700/20 blur-[120px]" />
        <div className="absolute -bottom-[15%] -right-[10%] w-[40vw] h-[40vw] rounded-full bg-yellow-700/15 blur-[120px]" />
        ...
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] rounded-3xl overflow-hidden border border-white/10 bg-slate-900/40 backdrop-blur-xl shadow-[0_25px_60px_rgba(0,0,0,0.55)]">
          <div className="hidden lg:flex flex-col justify-between p-10 bg-[linear-gradient(135deg,rgba(15,23,42,0.8),rgba(88,28,135,0.35))] border-r border-white/10">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-amber-700 to-yellow-600 flex items-center justify-center shadow-[0_0_25px_rgba(184,134,11,0.35)]">
                <ShieldCheck size={22} />
              </div>
              <div>
                <div className="font-bold text-xl">Admin Portal</div>
                <div className="text-xs uppercase tracking-[0.25em] text-amber-300">H_ARCH Studio</div>
              </div>
            </div>
          ...
          <div className="p-8 sm:p-10 lg:p-12 bg-[#0a0c13]">
            <div className="mb-8">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-amber-600/20 bg-amber-600/10 text-amber-300 text-xs font-semibold mb-4">
                <ShieldCheck size={14} />
                Admin Access Only
              </div>
              <h2 className="text-3xl font-bold font-display mb-2 bg-clip-text text-transparent bg-gradient-to-r from-white to-amber-300">
                Admin Login
              </h2>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-2xl bg-white/5 border border-white/10 pl-12 pr-4 py-4 text-white placeholder:text-slate-500 focus:outline-none focus:border-amber-600 focus:bg-black/50 transition-colors"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="mt-2 w-full rounded-2xl bg-gradient-to-r from-amber-700 to-yellow-600 px-5 py-4 font-semibold text-white shadow-[0_12px_30px_rgba(184,134,11,0.35)] hover:opacity-95 disabled:opacity-70 disabled:cursor-not-allowed transition-all"
              >
